...
interface PopularProps {
    showButtonsP: boolean;
    showListTypeP: boolean;
    showListTypePF: boolean;
}

const Popular: React.FC<PopularProps> = ({ showButtonsP, showListTypeP, showListTypePF }) => {
        ...
        <div className='block pl-7'>
            <div className="flex flex-wrap -mx-4">
                <div className="relative w-full px-4 md:w-9/12">
                    <h2 className="text-2xl font-semibold text-gray-800 mt-5 text-left ml-7 uppercase">Popular</h2>
                </div>
                {showButtonsP && (
